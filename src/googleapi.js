...
*/
    var m = this || self, n = "closure_uid_" + (1E9 * Math.random() >>> 0), da = 0, r = function (a) {
        return a
    };/*
...
*/
    ...
    var ia = {}, ja = function () {
        ...
        if (ia !== ia) throw Error("SafeHtml is not meant to be built directly");
        this.l = a
    };
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var F = window, G = document, ka = F.location, la = function () {
    }, ma = /\[native code\]/, H = function (a, b, c) {
        return a[b] = a[b] || c
    }, na = function (a) {
        a = a.sort();
        ...
        var a;
        if ((a = Object.create) && ma.test(a)) a = a(null); else {
            a = {};
    ...
    var O = H(M, "perf", I()), qa = H(O, "g", I()), ra = H(O, "i", I());
    H(O, "r", []);
    I();
    I();
    var P = function (a, b, c) {
        ...
        b && 0 < b.length && (b = ta(b), c && 0 < c.length && (b += "___" + ta(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = H(ra, "_p", I()), H(b, c, I())[a] = (new Date).getTime(), P(a, "_p", c))
    }, ta = function (a) {
        return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_")
    };
    var ua = I(), U = [], V = function (a) {
        throw Error("Bad hint: " + a);
    };
    U.push(["jsl", function (a) {
        for (var b in a) if (Object.prototype.hasOwnProperty.call(a, b)) {
            var c = a[b];
            "object" == typeof c ? M[b] = H(M, b, []).concat(c) : H(M, b, c)
        }
        if (b = a.u) a = H(M, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
    }]);
    var va = /^(\/[a-zA-Z0-9_\-]+)+$/, wa = [/\/amp\//, /\/amp$/, /^\/amp$/], xa = /^[a-zA-Z0-9\-_\.,!]+$/,
        ya = /^gapi\.loaded_[0-9]+$/, za = /^[a-zA-Z0-9,._-]+$/, Da = function (a, b, c, d, e) {
            var f = a.split(";"), k = f.shift(), t = ua[k], l = null;
            ...
            try {
                ...
                if (e && 0 < e.length) {
                    ...
                    for (d = {}; c < e.length;) {
                        ...
                        k = typeof p;
                        f = "object" == k && null !=
                        p || "function" == k ? "o" + (Object.prototype.hasOwnProperty.call(p, n) && p[n] || (p[n] = ++da)) : (typeof p).charAt(0) + p;
            ...
            for (var b = a.substring(1).split("/"), c = []; b.length;) {
                a = b.shift();
                if (!a.length || 0 == a.indexOf(".")) V("empty/relative directory"); else if (0 < a.indexOf("=")) {
                    b.unshift(a);
                    break
                }
                c.push(a)
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                var f = b[d].split("="), k = decodeURIComponent(f[0]), t =
        ...
        Ca = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, Ba = /\/cb=/g, Aa = /\/\//g;
    ...
    var X = decodeURI("%73cript"), Ha = /^[-+_0-9\/A-Za-z]+={0,2}$/, Ia = function (a, b) {
        ...
        var a = M.nonce;
        return void 0 !== a ? a && a === String(a) && a.match(Ha) ? a : M.nonce = null : G.querySelector ? (a = G.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(Ha) ? M.nonce = a : M.nonce = null) : null : null
    }, La = function (a) {
        ...
        var d = !!M.glrp;
        a = na(a) || [];
        var e = b.callback, f = b.config, k = b.timeout, t = b.ontimeout, l = b.onerror, p = void 0;
        "function" == typeof l && (p = l);
        var z = null, R = !1;
        if (k && !t || !k && t) throw "Timeout requires both the timeout parameter and ontimeout parameter to be set";
        l = H(N(c), "r", []).sort();
        var S = H(N(c), "L", []).sort(), Ta = M.le || [], K = [].concat(l), sa = function (w, C) {
            if (R) return 0;
            F.clearTimeout(z);
            S.push.apply(S, q);
            var D = ((J || {}).config || {}).update;
            D ? D(f) : f && H(M, "cu", []).push(f);
            if (C) {
                Q("me0", w, K);
                try {
                    Na(C, c, p)
        ...
        if (q.length) {
            q = Ia(a, l);
            var u = H(M, "CP", []), v = u.length;
            u[v] = function (w) {
                if (!w) return 0;
                Q("ml1", q, K);
                var C = function (L) {
                    d || (u[v] = null);
                    sa(q, w) && (d && (u[v] = null), pa(function () {
                        e &&
                        e();
                        L()
                    }))
    ...
    var Ra = null, Z = m.trustedTypes;
    if (Z && Z.createPolicy) try {
        Ra = Z.createPolicy("gapi#gapi", {createHTML: r, createScript: r, createScriptURL: r})
    } catch (a) {
    ...
    var Ma = function (a, b) {
        if (M.hee && 0 < M.hel) try {
            ...
            b && b(c), M.hel--, Pa("debug_error", function () {
                try {
    ...
    window.gapi.load("", {
        callback: window["gapi_onload"], _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.vi.tH07zQRqWJE.O/am=AAAQ/d=1/rs=AHpOoo-0SCAJxpjzUpjdvjM4boRWSEFDIg/m=__features__",
